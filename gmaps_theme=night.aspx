...
<pre style="text-align:center;color:white;">search restaurants or hotels nearby</pre>
<pre style="text-align:center;color:white;font-size:12px;">Team => { gautham, gopi, saiKrishna } </pre>
<div><button id="lightTheme">Light</button>&nbsp;<button id="nightTheme">Dark</button></div>
<p id="showNightText" style="color:#e95353;margin-top:10px;">Page is in dark !</p>
<input id='search' type="text"
placeholder="search restaurants" style="width:40%;padding:10px;text-align:center;border-radius:25px;
outline:none;margin-top:10px;border:none;background-color:#333;color:#fffc00;" autocomplete="off" 
spellcheck="false" maxlength="50"/><br/><br/>
<section class='map'>
<div id='map'></div>
</section>
</center>
...
window.location.replace('gmaps_theme=light.aspx')
})
